...
public class Car : MonoBehaviour
{
    ...
    [SerializeField] private List<PathCreatorMini> pathCreatorList = new List<PathCreatorMini>();
    private void Awake()
    {
    ...
    private PathCreatorMini GetPathCreatorBySlot(Slot slot)
    {
